...
#include "controller/other/MidLevelControlledsimMultirotor.h"

namespace CVG_BlockDiagram {

MidLevel_Controlled_simMultirotor::MidLevel_Controlled_simMultirotor( cvg_double x0, cvg_double y0, cvg_double z0) {
...
void MidLevel_Controlled_simMultirotor::reset( cvg_double x0, cvg_double y0, cvg_double z0) {
	reset();
	xc = x0, yc = y0, zc = z0;
	xo = x0, yo = y0, zo = z0;
}

void MidLevel_Controlled_simMultirotor::actualReset( cvg_double x0, cvg_double y0, cvg_double z0) {
...
void MidLevel_Controlled_simMultirotor::setInput( cvg_double xc, cvg_double yc, cvg_double zc, cvg_double vxc, cvg_double vyc, cvg_double vzc) {
	this->xc = xc;
	this->yc = yc;
	this->zc = zc;
	this->vxc = vxc;
...
void MidLevel_Controlled_simMultirotor::getOutput(cvg_double& xo_o, cvg_double& yo_o, cvg_double& zo_o, cvg_double& vxo_o, cvg_double& vyo_o, cvg_double& vzo_o) {
